...
#ifndef MTBFS_CR_HJ_H
#define MTBFS_CR_HJ_H
...
class MTBFSCRHJ : public Strategy
              , public ProcessNackTraits<MTBFSCRHJ>
{
public :
  explicit
  MTBFSCRHJ (Forwarder& forwarder, const Name& name = getStrategyName());
...
private :
  friend ProcessNackTraits<MTBFSCRHJ>;
