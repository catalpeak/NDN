...
class MTBFSERHJ : public Strategy
              , public ProcessNackTraits<MTBFSERHJ>
{
public :
  explicit
  MTBFSERHJ (Forwarder& forwarder, const Name& name = getStrategyName());
...
private :
  friend ProcessNackTraits<MTBFSERHJ>;
